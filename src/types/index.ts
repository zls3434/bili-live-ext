 ...
 * 直播分区信息
 *
 * 定义B站直播的主要分区，用于直播间列表的分区标签和筛选功能。
 * 分区 ID 与B站直播分区 API 中的 parent_area_id 对应。
 *
 * 修改日期：2026-05-04
 * 修改人：zls3434
 * 修改目的：新增直播分区枚举，支持按分区筛选推荐直播间
 */
export enum LiveArea {
  /** 全部分区（不筛选） */
  all = 0,
  /** 网游分区 */
  onlineGame = 2,
 ...
 * 直播排序方式枚举
 *
 * 定义直播间列表的排序方式，支持推荐排序和人气排序。
 *
 * 修改日期：2026-05-04
 * 修改人：zls3434
 * 修改目的：新增排序枚举，支持推荐/人气两种排序方式
 */
